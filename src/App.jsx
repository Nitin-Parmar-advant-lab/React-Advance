        ...
        <main>
            <section>
                ...
                <Accordion className="accordion">
                    {/* <AccordionItem */}
                    <Accordion.Item id="experince" className="accordion-item">
                        <Accordion.Title className="accordion-item-title">
                            We got 20 years of experience
                        </Accordion.Title>
                        <Accordion.Content className="accordion-item-content">
                            <article>
                                <p>You can&apos;t go wrong with up.</p>
                                <p>
                                    We are in business of planning highly
                                    individualized vaction trips for more then
                                    20 years.
                                </p>
                            </article>
                        </Accordion.Content>
